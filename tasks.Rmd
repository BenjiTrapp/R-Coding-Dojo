...
**Aufgabe** Lese das Inventory (Path2Repo/data/report.csv) in 
...
df <- read.csv('https://github.com/BenjiTrapp/R-Coding-Dojo/data/report.csv', header = TRUE, sep = ';', stringsAsFactors = FALSE)
